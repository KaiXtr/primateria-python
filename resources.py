...
def new_data():
    ...
    com.execute("CREATE TABLE inventory" + str(ID) + " (\
        ...
        it9 text,ip9 text,ic19 text,ic29 text,it10 text,ip10 text,ic110 text,ic210 text,it11 text,ip11 text,ic111 text,ic211 text,\
        it12 text,ip12 text,ic112 text,ic212 text,it13 text,ip13 text,ic113 text,ic213 text,it14 text,ip14 text,ic114 text,ic214 text,\
