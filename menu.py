...
class Shop:
	...
	def products(self, opt, lopt, lst):
		...
		self.scr[0].blit(self.fnt['CALIBRI'].render('$' + str(resources.MONEY), True, (255, 255, 255)), (20, 10))
	...
	def buy(self, opt, lopt, lst):
		...
		self.scr[0].blit(self.fnt['CALIBRI'].render('valor: ' + str(resources.MONEY), True, (255, 255, 255)), (305, 165))
		self.scr[0].blit(self.fnt['CALIBRI'].render('total: ' + str(cost), True, (255, 255, 255)), (305, 185))
		if resources.MONEY - cost > 0: pcol = (0,255,0)
		else: pcol = (255,0,0)
		self.scr[0].blit(self.fnt['CALIBRI'].render('troco: ' + str(resources.MONEY - cost), True, pcol), (305, 205))
	...
	def mercator(self, opt, lopt, lst, prm):
		...
		if opt == 0: self.scr[0].blit(self.fnt['CALIBRI'].render(database.SHOP[8], True, (resources.COLOR[0], resources.COLOR[1], resources.COLOR[2])), (20, 30))
		else: self.scr[0].blit(self.fnt['CALIBRI'].render(database.SHOP[8], True, (255,255,255)), (20, 30))
		x = 1
		for i in resources.PARTY[resources.FORMATION]:
			if opt == x: self.scr[0].blit(self.fnt['CALIBRI'].render(resources.CHARACTERS[i]['NAME'], True, (resources.COLOR[0], resources.COLOR[1], resources.COLOR[2])), (20 + (x * 60), 30))
			else: self.scr[0].blit(self.fnt['CALIBRI'].render(resources.CHARACTERS[i]['NAME'], True, (255,255,255)), (20 + (x * 60), 30))
			x += 1
		...
		for i in lst:
			if opt == 0:
				...
				if lopt == y:
					...
					self.scr[0].blit(self.fnt['CALIBRI'].render('$' + str(prc) + ' - ' + database.ITEMS[i][0], True, (0, 0, 0)), (20, 50 + (y * 15)))
				else:
					self.scr[0].blit(self.fnt['CALIBRI'].render('$' + str(prc) + ' - ' + database.ITEMS[i][0], True, (255, 255, 255)), (20, 50 + (y * 15)))
				if prm > 0:
					pygame.draw.rect(self.scr, (255, 170, 0), pygame.Rect(350,50 + (y * 15),30,20))
					self.scr[0].blit(self.fnt['DATETIME'].render(str(prm) + '%', True, (255, 255, 255)), (350, 50 + (y * 15)))
				y += 1
		...
		if lopt == y:
			pygame.draw.rect(self.scr, (255, 255, 255), pygame.Rect(15,50 + (y * 15),370,15))
			self.scr[0].blit(self.fnt['CALIBRI'].render(database.SHOP[1], True, (0, 0, 0)), (20, 50 + (y * 15)))
		else: self.scr[0].blit(self.fnt['CALIBRI'].render(database.SHOP[1], True, (255, 255, 255)), (20, 50 + (y * 15)))
	...
	def bank(self, opt, lopt, mn, ext):
		...
		if mn == 3:
			...
			self.scr[0].blit(self.fnt['TITLE'].render(str(resources.MONEY), True, (0,0,0)), (120, 150))
...
class Phone:
		...
		for i in em:
			...
			if flt > 0: self.scr[1].blit(self.fnt['CALIBRI'].render(i[0], True, (0, 0, 0)), (20, (76 + y - self.scroll) * 2))
				...
				if opt == y/51:
					...
					self.scr[0].blit(pygame.image.load('Sprites/tc_9.png'), (sz - 44, 76 + y - self.scroll))
					if mnu == 2: pygame.draw.rect(self.scr[0], (255, 255, 255), pygame.Rect(140,74 + y - self.scroll,24,24))
					self.scr[0].blit(pygame.image.load('Sprites/tc_8.png'), (sz - 22, 76 + y - self.scroll))
	...
	def tactics(self, opt, lopt, mnu, sg):
		...
		if sg > 0:
				...
				if i != [] and len(i) == 4:
					...
					if mnu > 0 and lopt == y/51:
						if mnu < 5:
							...
							if i[mnu - 1] == 1: self.scr[1].blit(self.fnt['CALIBRI'].render(database.MENU[54], True, (0, 0, 0)), (20, (70 + y - self.scroll) * 2))
							if i[mnu - 1] == 2: self.scr[1].blit(self.fnt['CALIBRI'].render(database.MENU[55], True, (0, 0, 0)), (20, (70 + y - self.scroll) * 2))
							if i[mnu - 1] == 3: self.scr[1].blit(self.fnt['CALIBRI'].render(database.MENU[56], True, (0, 0, 0)), (20, (70 + y - self.scroll) * 2))
							if i[mnu - 1] == 4: self.scr[1].blit(self.fnt['CALIBRI'].render(database.MENU[57], True, (0, 0, 0)), (20, (70 + y - self.scroll) * 2))
							if i[mnu - 1] == 5: self.scr[1].blit(self.fnt['CALIBRI'].render(database.MENU[58], True, (0, 0, 0)), (20, (70 + y - self.scroll) * 2))
							if i[mnu - 1] == 6: self.scr[1].blit(self.fnt['CALIBRI'].render(database.MENU[59], True, (0, 0, 0)), (20, (70 + y - self.scroll) * 2))
							if i[mnu - 1] == 7: self.scr[1].blit(self.fnt['CALIBRI'].render(database.MENU[60], True, (0, 0, 0)), (20, (70 + y - self.scroll) * 2))
			...
			self.scr[1].blit(self.fnt['CALIBRI'].render(database.MENU[36], True, (0, 0, 0)), (40, 100 + y - self.scroll))
