...
AVATAR = {
'humanoid_head': ['cabeça','redondo','quadrado','pontudo'],
'humanoid_hair': ['cabelo','careca','raspado','calvo','afro','cacheado curto','cacheado médio','cacheado longo','cacheado preso',
...
'humanoid_colors': ['olhos','redondo','puxado'],
'humanoid_eyes': ['olhos','redondo','puxado'],
'humanoid_eyebrows': ['sobrancelhas','fino','médio','grosso','rena','monocelha','corte'],
'humanoid_nose': ['nariz','fino','pontudo','longo','redondo','pequeno'],
'humanoid_facialhair': ['pelo facial','bigode fino','bigode pequeno','barba rala','barba cheia','barba longa','barbicha','cavanhaque'],
'humanoid_torso': ['peitoral','sem seios','seios pequenos','seios grandes'],
'humanoid_marks': ['marcas','sinal','cicatriz','sardas','vitiligo','queimadura','ferida'],
'humanoid_tatoos': ['tatuagens','runas','fogo','água','terra','ar'],
'humanoid_facepaint': ['pintura facial','listras','olhos','setas'],
'humanoid_mask': ['máscara','jason','vampiro'],
'humanoid_hat': ['chapéu','boné','gorro curto','gorro longo','chapéu de sol','sombreiro','chapéu de palha','boina','chapéu de aviador'],
'humanoid_glasses': ['óculos','óculos de grau redondo','óculos de grau quadrado','óculos escuros redondos','óculos escuros quadrados',
	'óculos 3D','visor de proteção'],
'humanoid_Lear': ['brinco','brinco pequeno','argola','piercing','alargador','fone'],
'humanoid_Rear': [],
'humanoid_neck': ['pescoço','corrente','terço','memento','bandana'],
'humanoid_piercings': ['piercings','esfera','barra'],
'humanoid_Lhand': ['luva esquerda','luva de pedreiro','luva de goleiro','luva de ciclista','luva sem dedos','luva de médico'],
'humanoid_Rhand': ['luva direita'],
'humanoid_Lpulse': ['pulso esquerda','relógio analógico','relógio digital','pulseira'],
'humanoid_Rpulse': ['pulso direito'],
'humanoid_uppercloth': ['flanela','moletom','jaqueta','terno','avental','macacão'],
'humanoid_shirt': ['camisa'],
'humanoid_pants': ['calça'],
'humanoid_dress': ['vestido','saia','mini saia','tutu','vestido'],
'humanoid_socks': ['meias'],
'humanoid_feet': ['pés','descalço','chinelo','chinelo chique','sapato esportivo','sapato social','bota','pantufa']
}
